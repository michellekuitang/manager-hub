...
const campagneSchema = new mongoose.Schema({
    ...
    statut: { type: String, enum: ['Active', 'Terminée', 'À venir', 'Brouillon'], default: 'Brouillon' },
    campus: { type: String, default: 'Tous' },
    budget: { type: Number, default: 0, min: 0 },
    depense: { type: Number, default: 0, min: 0 }, // Pour le calcul du CPL
    leads: { type: Number, default: 0, min: 0 },   // Nombre de leads générés
    clics: { type: Number, default: 0, min: 0 },   // Nombre de clics
