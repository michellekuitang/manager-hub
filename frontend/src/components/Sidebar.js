...
const Sidebar = () => {
    ...
    return (
        <div className={`min-h-screen bg-[#111827] text-gray-100 flex flex-col justify-between border-r border-gray-800 transition-all duration-300 ${
            isCollapsed ? 'w-20' : 'w-64'
        }`}>
            {/* HAUT : Logo & En-tête */}
            <div>
                <div className={`p-5 border-b border-gray-800 flex items-center gap-3 ${isCollapsed ? 'justify-center' : ''}`}>
            ...
            {/* BAS : Bouton Chevron & Espace Utilisateur */}
